...
@section('navigation')
    <div class="row">
        <div class="col s10 m6 l6">
            <h5 class="breadcrumbs-title">Crear Libro</h5>
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <h4 class="header2">Registro de Libros</h4>
                    <div class="row">
                        <form id="book_form" action="{{ route('books.store') }}" enctype="multipart/form-data" method="post" class="col s12">
                            @csrf
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    <i class="material-icons prefix">title</i>
                                    <input name="title" id="title" type="text" class="validate" data-length="255" value="{{old('title')}}" required/>
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <input name="edition" id="edition" type="number" class="validate" value="{{old('edition')}}" required/>
                            ...
                            <div class="row">
                                ...
                                <div id="date-picker" class="section col s12 m6 l6">
                                    ...
                                    <input id="publication_date" name="publication_date" type="text" class="datepicker" required value="{{old('publication_date')}}">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <select id="genres" name="genres[]" multiple required>
                                        ...
                                        @foreach($genres as $genre)
                                            <option value="{{$genre->id}}" @if(old('genres') && in_array($genre->id, old('genres'))) selected @endif>{{$genre->genre}}</option>
                                        @endforeach
                                    </select>
